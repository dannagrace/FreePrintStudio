...
- Run `Scripts/preflight_app_store_archive.sh` and fix every failed step before archiving; it starts with `Scripts/verify_release.sh store-ready`, then checks private release inputs, App Review contact, signing assets, and the readiness audit.
