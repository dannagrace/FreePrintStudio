...
- Run `Scripts/capture_app_store_screenshot_set.sh` after fit mode, paper, orientation, or unit UI changes and inspect `iphone-fit.jpg`, `iphone-fill.jpg`, `iphone-stretch.jpg`, and `iphone-metric-landscape.jpg`.
