...
- Run `Scripts/validate_release_handoff_brief.sh build/CISubmissionPacket/external-readiness-actions.tsv build/release-handoff-brief.md` if the generated handoff files are moved or reviewed later; it verifies that the human-readable brief still matches the external action manifest.
