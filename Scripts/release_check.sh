...
check_contains "Scripts/verify_release.sh" 'SUBMISSION_PACKET_TIMEOUT_SECONDS="${FREEPRINTSTUDIO_SUBMISSION_PACKET_TIMEOUT_SECONDS:-240}"' "Submission packet generation must have a command-level timeout below the CI step limit"
