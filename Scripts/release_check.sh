...
check_contains "README.md" "APP_STORE_BUILD_NUMBER=1 Scripts/validate_manual_release_verification.sh" "README must show manual release evidence validation against the selected App Store build"
...
check_contains "Scripts/prepare_app_store_submission_packet.sh" "APP_STORE_BUILD_NUMBER=1 Scripts/validate_manual_release_verification.sh" "Submission packet command order must validate manual evidence against the selected App Store build"
